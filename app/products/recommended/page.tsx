export const metadata = {
  ...
  description:
    "Derm-recommended luxury skincare from EltaMD, iS Clinical, SkinMedica, La Roche-Posay, ISDIN, ALASTIN, and SkinCeuticals — shop on Amazon with verified reviews.",
};
